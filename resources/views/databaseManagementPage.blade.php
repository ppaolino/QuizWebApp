                ...
                <div class="row">
                    <div class="col-md-6 col-12 text-center">
                        ...
                        <form id="addPlayerForm" enctype="multipart/form-data" class="mb-4 text-center">
                            ...
                            <button type="button" class="btn btn-primary" id="addPlayerBtn">@lang('messages.addPlayer')
                            </button>
                        </form>
                    </div>
                    <div class="col-md-6 col-12 text-center">
                        ...
                        <form id="editPlayerForm" class="mt-2 mb-4 text-center">
                            ...
                            <button type="button" class="btn btn-warning" id="editPlayerBtn">@lang('messages.modifyPlayer')
                            </button>
                        </form>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12 text-center">
                        ...
                        <form id="editTeamForm" class="mt-2 mb-4 text-center" enctype="multipart/form-data">
                            ...
                            <button type="button" class="btn btn-warning" id="editTeamBtn">@lang('messages.modifyTeam')
                            </button>
                        </form>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-12 text-center">
                        ...
                        <form id="addLeagueForm" enctype="multipart/form-data" class="mb-4 text-center">
                            ...
                            <button type="button" class="btn btn-primary" id="addLeagueBtn">@lang('messages.addLeague')
                            </button>
                        </form>
                    </div>
                    <div class="col-md-6 col-12 text-center">
                        ...
                        <form id="editLeagueForm" class="mt-2 mb-4 text-center" enctype="multipart/form-data">
                            ...
                            <button type="button" class="btn btn-warning" id="editLeagueBtn">@lang('messages.modifyLeague')
                            </button>
                        </form>
                    </div>
                </div>
